...
<ol class="toolbar">
    <li class="btn-item"><a title="Nuevo" href="/producto/marca/nuevo" class="fab fa-product-hunt" aria-hidden="true"><span>Nuevo</span></a></li>
...
<script>
	var dataTable = $('#grilla').DataTable({
        ...
        "pageLength": 25,
        "order": [[ 0, "asc" ]],
	    "ajax": "{{ route('producto-marca.cargarGrilla') }}"
	});
</script>
@endsection