        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <input type="text" id="txtTitulo_del_sitio" name="txtTitulo_del_sitio" class="form-control" value="{{$menu->titulo_del_sitio or ''}}" required>
                </div>
                 <div class="form-group col-lg-12">
                 <label>Email: *</label>
                 <input type="email" id="txtEmail_contacto" name="txtEmail_contacto" class="form-control" value="{{$menu->email_contacto or ''}}" required>
                  </div>
            </div>
...
<script>
    ...
    function eliminar() {
        $.ajax({
            type: "GET",
            url: "{{ asset('configuracion/eliminar') }}",
            data: { id:globalId },
            async: true,
            dataType: "json",
